...
export const rooms: Room[] = [
  // Property 1 - Floor 1
  { id: '1', propertyId: '1', roomNumber: '101', floor: 1, roomType: 'standard', sizeSqm: 12, occupancyType: 'double', baseMonthlyRent: 2000000, additionalPersonFee: 500000, amenities: { ac: true, privateBathroom: true, balcony: false, tv: true, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-101', createdAt: new Date(), updatedAt: new Date() },
  { id: '2', propertyId: '1', roomNumber: '102', floor: 1, roomType: 'deluxe', sizeSqm: 16, occupancyType: 'single', baseMonthlyRent: 2500000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: true, tv: true, refrigerator: true, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-102', createdAt: new Date(), updatedAt: new Date() },
  { id: '3', propertyId: '1', roomNumber: '103', floor: 1, roomType: 'standard', sizeSqm: 12, occupancyType: 'single', baseMonthlyRent: 1800000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: false, balcony: false, tv: false, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'available', acUnitId: 'AC-103', createdAt: new Date(), updatedAt: new Date() },
  { id: '4', propertyId: '1', roomNumber: '104', floor: 1, roomType: 'premium', sizeSqm: 20, occupancyType: 'single', baseMonthlyRent: 3000000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: true, tv: true, refrigerator: true, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-104', createdAt: new Date(), updatedAt: new Date() },
  { id: '5', propertyId: '1', roomNumber: '105', floor: 1, roomType: 'standard', sizeSqm: 12, occupancyType: 'single', baseMonthlyRent: 1800000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: false, balcony: false, tv: false, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'maintenance', acUnitId: 'AC-105', createdAt: new Date(), updatedAt: new Date() },
  // Property 1 - Floor 2
  { id: '6', propertyId: '1', roomNumber: '201', floor: 2, roomType: 'standard', sizeSqm: 12, occupancyType: 'single', baseMonthlyRent: 1900000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: false, balcony: false, tv: false, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-201', createdAt: new Date(), updatedAt: new Date() },
  { id: '7', propertyId: '1', roomNumber: '202', floor: 2, roomType: 'deluxe', sizeSqm: 16, occupancyType: 'double', baseMonthlyRent: 2400000, additionalPersonFee: 500000, amenities: { ac: true, privateBathroom: true, balcony: true, tv: true, refrigerator: true, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-202', createdAt: new Date(), updatedAt: new Date() },
  { id: '8', propertyId: '1', roomNumber: '203', floor: 2, roomType: 'standard', sizeSqm: 12, occupancyType: 'single', baseMonthlyRent: 1900000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: false, balcony: false, tv: false, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'available', acUnitId: 'AC-203', createdAt: new Date(), updatedAt: new Date() },
  { id: '9', propertyId: '1', roomNumber: '204', floor: 2, roomType: 'standard', sizeSqm: 12, occupancyType: 'single', baseMonthlyRent: 1900000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: false, balcony: false, tv: false, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-204', createdAt: new Date(), updatedAt: new Date() },
  { id: '10', propertyId: '1', roomNumber: '205', floor: 2, roomType: 'premium', sizeSqm: 22, occupancyType: 'single', baseMonthlyRent: 3200000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: true, tv: true, refrigerator: true, wardrobe: true, desk: true, wifi: true }, status: 'reserved', acUnitId: 'AC-205', createdAt: new Date(), updatedAt: new Date() },
  // Property 2
  { id: '11', propertyId: '2', roomNumber: '101', floor: 1, roomType: 'standard', sizeSqm: 14, occupancyType: 'single', baseMonthlyRent: 2200000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: false, tv: true, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-101', createdAt: new Date(), updatedAt: new Date() },
  { id: '12', propertyId: '2', roomNumber: '102', floor: 1, roomType: 'deluxe', sizeSqm: 18, occupancyType: 'single', baseMonthlyRent: 2800000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: true, tv: true, refrigerator: true, wardrobe: true, desk: true, wifi: true }, status: 'occupied', acUnitId: 'AC-102', createdAt: new Date(), updatedAt: new Date() },
  { id: '13', propertyId: '2', roomNumber: '103', floor: 1, roomType: 'standard', sizeSqm: 14, occupancyType: 'single', baseMonthlyRent: 2200000, additionalPersonFee: 0, amenities: { ac: true, privateBathroom: true, balcony: false, tv: true, refrigerator: false, wardrobe: true, desk: true, wifi: true }, status: 'available', acUnitId: 'AC-103', createdAt: new Date(), updatedAt: new Date() },
];
